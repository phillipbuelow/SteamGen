function setup(p, sh, rh, ev, ph, d)
    ...
    n["N_p"] = 50
    n["N_s_p"] = n["N_p"]
    n["N_mw_p"] = n["N_s_p"] + n["N_p"]

    # Superheater
    n["N_sh"] = sh["N_baffles"]
    n["N_s_sh"] = n["N_mw_p"] + n["N_sh"]
    n["N_m_sh"] = n["N_s_sh"] + n["N_sh"]
    n["N_w_sh"] = n["N_m_sh"] + n["N_sh"]
    n["N_mw_sh"] = n["N_w_sh"] + n["N_sh"]
    n["N_ts"] = 20
    n["N_uts_sh"] = n["N_mw_sh"] + n["N_ts"]
    n["N_lts_sh"] = n["N_uts_sh"] + n["N_ts"]

    # Reheater
    n["N_rh"] = rh["N_baffles"]
    n["N_s_rh"] = n["N_lts_sh"] + n["N_rh"]
    n["N_m_rh"] = n["N_s_rh"] + n["N_rh"]
    n["N_w_rh"] = n["N_m_rh"] + n["N_rh"]
    n["N_mw_rh"] = n["N_w_rh"] + n["N_rh"]
    n["N_uts_rh"] = n["N_mw_rh"] + n["N_ts"]
    n["N_lts_rh"] = n["N_uts_rh"] + n["N_ts"]

    # Evaporator
    n["N_ev"] = ev["N_baffles"]
    n["N_s_ev"] = n["N_lts_rh"] + n["N_ev"]
    n["N_m_ev"] = n["N_s_ev"] + n["N_ev"]
    n["N_w_ev"] = n["N_m_ev"] + n["N_ev"]
    n["N_mw_ev"] = n["N_w_ev"] + n["N_ev"]
    n["N_uts_ev"] = n["N_mw_ev"] + n["N_ts"]
    n["N_lts_ev"] = n["N_uts_ev"] + n["N_ts"]

    # Preheater
    n["N_ph"] = ph["N_baffles"]
    n["N_s_ph"] = n["N_lts_ev"] + n["N_ph"]
    n["N_m_ph"] = n["N_s_ph"] + n["N_ph"]
    n["N_w_ph"] = n["N_m_ph"] + n["N_ph"]
    n["N_mw_ph"] = n["N_w_ph"] + n["N_ph"]
    n["N_uts_ph"] = n["N_mw_ph"] + n["N_ts"]
    n["N_lts_ph"] = n["N_uts_ph"] + n["N_ts"]
